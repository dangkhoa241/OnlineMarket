                            ...
                            <div class="module">
                                ...
                                <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Product Decription</label>
                                            <div class="controls">
                                                <input type="text" name="productDecription" placeholder="Enter Product Decription" class="span8 tip" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="productImage" placeholder="Enter Product Image" class="span8 tip" required>
                                            </div>
                                        </div>
